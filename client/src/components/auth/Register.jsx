...
const Register = () => {
    ...
    return (
        <div className="w-[100vw] flex items-center justify-center bg-[#1c1e26] px-4 pt-[6em] md:pt-[8em] lg:pt-[12em] xl:pt-[16em]">
            <div className="max-w-md w-full space-y-8 bg-[#31343D] p-8 rounded-xl">
                ...
                <div className="text-center">
                    <Link to="/login" className="text-[#128d8a] hover:text-[#1ac9c6]">
