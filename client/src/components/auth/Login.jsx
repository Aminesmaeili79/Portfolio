...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://portfolio-ofdg.onrender.com/api/auth/login', { email, password });
    ...
    return (
        <div className="w-[100vw] flex items-start justify-center bg-[#1c1e26] px-4 pt-[6em] md:pt-[8em] lg:pt-[12em] xl:pt-[16em]">
