        ...
        <nav className="text-[#dffffd] w-[100vw] px-[4em] py-[2em] md:px-[8em] md:py-[2em] lg:px-[16em] lg:py-[4em] flex gap-8 justify-between items-center">
            ...
            <div className="flex justify-between items-center gap-8 nav__links">
                <div className="hidden md:flex gap-2 socials">
                    ...
                    <a href="https://linkedin.com/in/aminesmaeili79" className="linkedin">
                    ...
                    <a href="mailto:aminesmaeili79@yahoo.com" className="email">
                ...
                <div className="hamburger flex flex-col md:hidden">
                    ...
                    {isHamburgerOpen ?
                        <>
                            <div className="absolute right-16 top-0 translate-y-[100%] z-10" onClick={handleHamburgerOpen}>
                            ...
                            <ul className="absolute text-[2rem] flex flex-col items-center justify-center gap-[2em] bg-[rgb(28,30,38)] overflow-visible w-[100vw] h-[100vh] right-0 top-0">
                                <li>
